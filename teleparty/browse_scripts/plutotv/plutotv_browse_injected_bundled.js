...
;// ./src/Teleparty/BrowseScripts/PlutoTV/plutotv_browse_injected.js
...
function addNativePartyButton() {
    ...
    const playButton = ((_d = (_c = (_b = (_a = document.querySelector('[class*="actions"]')) === null || _a === void 0 ? void 0 : _a.firstChild) === null || _b === void 0 ? void 0 : _b.firstChild) === null || _c === void 0 ? void 0 : _c.firstChild) === null || _d === void 0 ? void 0 : _d.firstChild) ||
        ((_e = document.querySelector('[class*="actionButtonsContainer"]')) === null || _e === void 0 ? void 0 : _e.firstChild);
    if (playButton == null) {
        return undefined;
    }
...
addNativePartyHandler(addNativePartyButton, InternalStreamingServiceName.PLUTO_TV);
