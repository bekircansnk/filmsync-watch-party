...
;// ./src/Teleparty/BrowseScripts/FoxOne/foxone_browse_injected.js
...
function addNativePartyButton() {
    ...
    const playButton = document.querySelector("[data-testid='DetailWatchButton']") ||
        document.querySelector("[data-testid='white-button']");
    if (playButton == null) {
        return undefined;
    }
    ...
    nativePartyButton.setAttribute("style", "background: linear-gradient(273.58deg, #9E55A0 0%, #EF3E3A 100%); border-color: #e50914; color: #fff; justify-content: center; align-items: center; grid-column: 1 / -1; flex-basis: auto; flex: 0 0 auto; display: flex; margin-top: 10px;");
