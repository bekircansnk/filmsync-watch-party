...
;// ./src/Teleparty/BrowseScripts/Peacock/peacock_browse_injected.js
...
function addNativePartyButton() {
    ...
    playButtonList.forEach((playButton) => {
        ...
        nativeButtons.push({ button: nativePartyButton, play: (e) => playButton.click() });
    });
    return nativeButtons;
}
addNativePartyHandler(addNativePartyButton, InternalStreamingServiceName.PEACOCK);
