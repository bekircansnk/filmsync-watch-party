...
;// ./src/Teleparty/BrowseScripts/JioCinema/jio_cinema_browse_injected.js
...
function addNativePartyButton() {
    ...
    return [{ button: nativePartyButton, play: (e) => watchButton.click() }];
}
addNativePartyHandler(addNativePartyButton, InternalStreamingServiceName.JIO_CINEMA);
