...
;// ./src/Teleparty/BrowseScripts/Shudder/shudder_browse_injected.js


function addNativePartyButton() {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    let playButtons = document.querySelectorAll("#page-series-detail__btn-play, #page-movie-detail__btn-play, .js-play");
    const detailPagePlayButton = (_a = document.querySelector("img[alt='Play']")) === null || _a === void 0 ? void 0 : _a.parentElement;
    const detailPagePlayButtonContainer = (_h = (_g = (_f = (_e = (_d = (_c = (_b = document.querySelector("img[alt='Play']")) === null || _b === void 0 ? void 0 : _b.parentElement) === null || _c === void 0 ? void 0 : _c.parentElement) === null || _d === void 0 ? void 0 : _d.parentElement) === null || _e === void 0 ? void 0 : _e.parentElement) === null || _f === void 0 ? void 0 : _f.parentElement) === null || _g === void 0 ? void 0 : _g.parentElement) === null || _h === void 0 ? void 0 : _h.parentElement;
    let detailedPagePlayButtonClass = "";
    if (detailPagePlayButton) {
        detailedPagePlayButtonClass = (_k = (_j = document.querySelector("img[alt='Play']")) === null || _j === void 0 ? void 0 : _j.parentElement) === null || _k === void 0 ? void 0 : _k.getAttribute("class");
        playButtons = [...playButtons, detailPagePlayButton];
    }
    ...
    playButtons.forEach((playButton, index) => {
        const parentDiv = detailPagePlayButtonContainer || playButton.parentElement;
        if (!parentDiv)
            return;
        // Prevent duplicate injection inside same parent
        if (parentDiv.querySelector(".native-party-button"))
            return;
        const playClass = detailedPagePlayButtonClass || playButton.getAttribute("class") || "";
        const nativePartyButton = document.createElement("button");
        nativePartyButton.setAttribute("class", `${playClass} native-party-button`);
        nativePartyButton.setAttribute("style", "background: linear-gradient(273.58deg, #9E55A0 0%, #EF3E3A 100%); border-color: #e50914; color: #fff; justify-content: center; align-items: center; grid-column: 1 / -1; flex-basis: auto; flex: 0 0 auto; display: flex;");
        // Use unique id if you still want one
        nativePartyButton.setAttribute("id", `native-party-button-${index}`);
        nativePartyButton.innerHTML =
            '<span style="width: unset; text-wrap: nowrap; text-align: center;">Start a Teleparty</span>';
        parentDiv.appendChild(nativePartyButton);
        results.push({
...
addNativePartyHandler(addNativePartyButton, InternalStreamingServiceName.SHUDDER);
