...
;// ./src/Teleparty/BrowseScripts/HboMax/hbo_max_browse_injected.js
...
function addNativePartyButton() {
    ...
    nativePartyButton.setAttribute("style", "background: linear-gradient(273.58deg, #9E55A0 0%, #EF3E3A 100%); color: #fff; border: none; padding: 16px 24px;");
...
addNativePartyHandler(addNativePartyButton, InternalStreamingServiceName.HBO_MAX);
