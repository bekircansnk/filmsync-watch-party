...
// Scrubber bar: [data-testid="player-video-scrub-bar"] -> parentElement
// Props: duration (seconds), userProgress (seconds), playerAdState.isInAdBreak,
//        seeking (bool), onSeekEnd(ratio, timeInSeconds)
const getScrubberApi = () => {
    ...
    try {
        ...
        if (!elementRoot)
            return undefined;
        const fiber = getReactInternals(elementRoot);
        return (_e = (_d = (_c = (_b = (_a = fiber === null || fiber === void 0 ? void 0 : fiber.child) === null || _a === void 0 ? void 0 : _a.return) === null || _b === void 0 ? void 0 : _b.return) === null || _c === void 0 ? void 0 : _c.return) === null || _d === void 0 ? void 0 : _d.return) === null || _e === void 0 ? void 0 : _e.memoizedProps;
    }
    catch (e) {
        return undefined;
    }
};
// Cache last known state for when scrubber is temporarily unmounted
let _lastKnownState = {
    time: 0,
    duration: 0,
};
var seekInteraction = function (event) {
    ...
    switch (event_type) {
        case "GetState": {
            ...
            let time, isSeeking, isAdPlaying, duration;
            if (scrubberApi) {
                time = scrubberApi.userProgress * 1000; // seconds -> ms
                duration = scrubberApi.duration * 1000; // seconds -> ms
                isAdPlaying = (_b = (_a = scrubberApi.playerAdState) === null || _a === void 0 ? void 0 : _a.isInAdBreak) !== null && _b !== void 0 ? _b : false;
                isSeeking = (_c = scrubberApi.seeking) !== null && _c !== void 0 ? _c : false;
                _lastKnownState = { time, duration };
            }
            else {
                // Scrubber unmounted — don't infer ad state, use cached values
                isAdPlaying = false;
                isSeeking = false;
        ...
        case "seek": {
            const scrubberApi = getScrubberApi();
            if (scrubberApi === null || scrubberApi === void 0 ? void 0 : scrubberApi.onSeekEnd) {
                const timeInSeconds = event.data.timestamp / 1000; // ms -> seconds
                scrubberApi.onSeekEnd(0, timeInSeconds);
            }
            const evt = new CustomEvent("FromNode", {
                detail: {
                    type: "Seek",
