        ...
        try {
          if (action === 'play') {
            ...
            if (p !== undefined && typeof p.catch === 'function') {
              p.catch(e => Logger.error('[Evo ve Beko Inject] Netflix play hatası:', e));
            }
          } else if (action === 'pause') {
            player.pause();
          } else if (action === 'seek') {
      ...
      if (player) {
        try {
          if (action === 'play') {
            let p = player.play();
            if (p !== undefined && typeof p.catch === 'function') {
              p.catch(e => Logger.error('[Evo ve Beko Inject] Disney+ play hatası:', e));
            }
          } else if (action === 'pause') {
            player.pause();
          } else if (action === 'seek') {
      ...
      if (player) {
        try {
          if (action === 'play' && typeof player.playVideo === 'function') {
            let p = player.playVideo();
            if (p !== undefined && typeof p.catch === 'function') {
              p.catch(e => Logger.error('[Evo ve Beko Inject] YouTube play hatası:', e));
            }
