        ...
        try {
          if (action === 'play') {
            ...
            if (playPromise !== undefined) {
              playPromise.catch(e => Logger.error('[Evo ve Beko Inject] Play promise rejected:', e));
            }
          } else if (action === 'pause') {
            player.pause();
          } else if (action === 'seek') {
      ...
      if (player) {
        try {
          if (action === 'play' && typeof player.playVideo === 'function') {
            ...
            if (playPromise !== undefined) {
              playPromise.catch(e => Logger.error('[Evo ve Beko Inject] YouTube play promise rejected:', e));
            }
