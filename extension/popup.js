          ...
          card.innerHTML = `
            <div class="public-room-info">
              <div class="public-room-code-badge">
                <span>🔑 <span class="room-id-placeholder"></span></span>
              </div>
            ...
            <div style="display: flex; align-items: center; gap: 4px;">
              ...
              <button class="btn-delete-public" title="Boş Odayı Sil (İmha Et)" style="display: none;">🗑️</button>
            </div>
          `;

          card.querySelector('.room-id-placeholder').textContent = roomId;
