...
function showAutoJoinOverlay(roomName) {
  ...
  document.getElementById('filmsync-autojoin-roomname').textContent = '"' + roomName + '" Odasına Katılınıyor...';
}
...
function showNamePromptModal(roomName, callback) {
  ...
  document.getElementById('filmsync-nameprompt-roomname').textContent = '"' + roomName + '" odasına katılacaksınız.';
