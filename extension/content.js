    ...
    if (PlayerAdapter.isNetflix() || PlayerAdapter.isDisney() || PlayerAdapter.isYouTube()) {
      ...
      try {
        ...
        if (playPromise !== undefined) {
          playPromise.catch(e => Logger.error('[FilmSync] Play promise rejected:', e));
        }
      } catch (e) {
        Logger.error('[FilmSync] Error calling play:', e);
      }
    }
  },
  ...
  pause: () => {
    if (PlayerAdapter.isNetflix() || PlayerAdapter.isDisney() || PlayerAdapter.isYouTube()) {
      ...
      try {
        ...
        Logger.error('[FilmSync] Error calling pause:', e);
      }
    }
  },
  ...
  seek: (seconds) => {
    if (PlayerAdapter.isNetflix() || PlayerAdapter.isDisney() || PlayerAdapter.isYouTube()) {
      ...
      try {
        ...
        Logger.error('[FilmSync] Error setting currentTime:', e);
      }
    }
  }
};
