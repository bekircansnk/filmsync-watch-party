...
const PlayerAdapter = {
  ...
  play: () => {
    try {
      ...
      console.error('[FilmSync] Hata: play metodu başarısız oldu.', e);
    }
  },
  ...
  pause: () => {
    try {
      ...
      console.error('[FilmSync] Hata: pause metodu başarısız oldu.', e);
    }
  },
  ...
  seek: (seconds) => {
    try {
      ...
      console.error('[FilmSync] Hata: seek metodu başarısız oldu.', e);
    }
  }
};
