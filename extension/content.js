...
function showNamePromptModal(roomName, callback) {
  ...
  `;
  const roomTextContainer = modal.querySelector('#filmsync-name-prompt-room-text');
  if (roomTextContainer) {
    roomTextContainer.textContent = `"${roomName}" odasına katılacaksınız.`;
  }
