...
const PlayerAdapter = {
  ...
  play: () => {
    if (PlayerAdapter.isNetflix() || PlayerAdapter.isDisney() || PlayerAdapter.isYouTube()) {
      ...
      videoElement.play().catch(e => Logger.error('[FilmSync] Video play error:', e));
    }
  },
...
function handlePlayEvent(e) {
  try {
    ...
    Logger.error('[FilmSync] Error in handlePlayEvent:', err);
  }
}
...
function handlePauseEvent(e) {
  try {
    ...
    Logger.error('[FilmSync] Error in handlePauseEvent:', err);
  }
}
...
function handleSeekEvent(e) {
  try {
    ...
    Logger.error('[FilmSync] Error in handleSeekEvent:', err);
  }
}
...
function handleWaitingEvent() {
  try {
    ...
    Logger.error('[FilmSync] Error in handleWaitingEvent:', err);
  }
}
...
function handlePlayingEvent() {
  try {
    ...
    Logger.error('[FilmSync] Error in handlePlayingEvent:', err);
  }
}
