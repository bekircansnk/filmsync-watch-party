...
function showAutoJoinOverlay(roomName) {
  ...
  overlay.innerHTML = `
    ...
    <div id="filmsync-autojoin-room-text" style="font-size: 1.2rem; color: #45f3ff; font-weight: 600; margin-bottom: 20px;">
    </div>
  ...
  `;
  const roomTextDiv = overlay.querySelector('#filmsync-autojoin-room-text');
  if (roomTextDiv) {
...
function showNamePromptModal(roomName, callback) {
  ...
  const promptRoomText = modal.querySelector('#filmsync-prompt-room-text');
  if (promptRoomText) {
